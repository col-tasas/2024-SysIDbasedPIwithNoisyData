...
PK2=10*eye(5);  % initial matrix PK=H_t^{-1}
...
save("RLS_PI_Boundednonvanish")
subplot(2,1,1);
plot(Normalized_data(phistory2,Pstar),'linewidth',1,'color','red');
...
subplot(2,1,2)
plot(Normalized_data(khistory2,-Kstar),'linewidth',1,'color','red');
xlabel('$\mathrm{iteration~index}$','interpreter','latex','FontSize',12);
